<?php
	$json_string1 = file_get_contents("http://api.wunderground.com/api/0215dd2f84808f33/astronomy/q/IA/Mugas.json");
	$json_string2 = file_get_contents("http://api.wunderground.com/api/0215dd2f84808f33/planner_07010731/q/IA/Mugas.json");
	$json_string3 = file_get_contents("http://api.wunderground.com/api/0215dd2f84808f33/yesterday/q/IA/Mugas.json");
